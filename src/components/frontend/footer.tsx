  ...
  return (
    <footer className="border-t">
      <div className="max-w-screen-2xl mx-auto">
        <div className="py-12 grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-x-8 gap-y-10 px-4 sm:px-6 ">
          <div className="col-span-full xl:col-span-2 flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2 underline mb-4">
            ...
            <div className="flex items-center gap-5 text-muted-foreground">
              {(() => {
                ...
                const socials = [
                  ...
                  { key: 'whatsapp', href: s?.whatsapp, Icon: WhatsappIcon, label: 'WhatsApp' },
        ...
        <div className="py-8 flex flex-col sm:flex-row items-center justify-between gap-x-2 gap-y-5 px-4 sm:px-6 xl:px-4">
